...
<div className="flex flex-col md:flex-row justify-between items-center bg-black px-[135px] py-[50px]">
  <div className="text-black md:w-[50%] w-[100%]">
      <h2 className="text-[20px] md:text-[32px] font-semibold text-white"><span className="text-[#FF9F0D]">St</span>ill Need Our Support?</h2>
      <p className="text-[10px] md:text-[16px] font-normal mt-[17px] text-white">Don&#39;t wait make a smart & logical quote here. Its pretty easy.</p>
  </div>
  ...
  <div>
    ...
    <ul className="text-gray-500  font-medium">
      ...
      <li className="flex gap-[16.5px]">
        ...
        <Image className="p-6" src="/foot-4.png" alt="Fod" width={100} height={100} />
        </div>
...
{/* Post 1 */}
<li className="flex gap-[16.5px]">
<Image src="/foot.png" alt="Fod" width={100} height={100}/>
<div className="ml-1">
<h2 
className="
  text-[16px] 
...
{/* Post 2 */}
<li className="flex gap-[16.5px]">
<Image src="/foot-2.png" alt="Fod" width={100} height={100} />
<div className="ml-1">
<h2 
className="
  text-[16px] 
...
{/* Post 3 */}
<li className="flex gap-[16.5px]">
<Image src="/foot-3.png" alt="Fod"  width={100} height={100}/>
<div className="ml-1">
<h2 
className="
  text-[16px] 
...
<div className="w-[100%] px-4 py-6 bg-[#FF9F0D] dark:bg-[#FF9F0D] md:flex md:items-center md:justify-evenly">
...
Copyright @ 2024 by Sufyan Khan. All RightsReserved.
  ...
  <div className="flex justify-center gap-[14px] ">
    <div>
    <Image src="/facebook.png" alt="Fod"  width={20} height={30}/>
    </div>
    <div>
    <Image src="/twiter.png" alt="Fod"  width={30} height={100}/>
    </div>
    <div>
    <Image src="/insta.png" alt="Fod"  width={30} height={100}/>
    </div>
    <div>
    <Image src="/youtube.png" alt="Fod"  width={30} height={100}/>
    </div>
    <div>
    <Image src="/p.png" alt="Fod"  width={30} height={100}/>
    </div>
</div>
</div>
